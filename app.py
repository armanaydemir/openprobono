...
with gr.Blocks(
    ...
    user_agent = gr.Checkbox(label="isMobile", default=False, visible=False, render=False)
    #loading user agent
    ...
    with gr.Row(elem_id="therow") as the_row:
        ...
        with gr.Column(scale=0, elem_id="tools_col", visible=(not user_agent)) as tools_col:
